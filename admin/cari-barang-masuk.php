					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<?php 
			                    ...
			                    $cari = $_POST['cari'];
			                    $sql = "SELECT * FROM barang_masuk WHERE kode_barang LIKE '%$cari%' OR nama_barang LIKE '%$cari%' OR kapal LIKE '%$cari%' OR tanggal LIKE '%$cari%' OR supplier LIKE '%$cari%'";
