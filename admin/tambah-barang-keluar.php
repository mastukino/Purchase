	...
	<div class="row">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_keluar(kode_barang,nama_barang,tujuan,tanggal,operator) VALUES('$kode_barang','$nama_barang','$tujuan','$tanggal','$operator')");
