	...
	<div class="row">
	        ...
	        <nav class="row top-nav blue darken-2">
	    		<div class="container">
	    			<div class="col offset-l2 nav-wrapper">
	    				...
	    				<a class="page-title">Input Barang Masuk</a>
	    			</div>
	    		</div>
			</nav>
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
			              	...
			              	<tr>
			                	<th>Kapal/Bengkel</th>
			                	<th><input type="text" name="kapal" required></th>
			             	</tr>
			             	<tr>
			                	<th>Tanggal</th>
			              	...
			              	<tr>
			                	<th>Supplier</th>
			                	<th><input type="text" name="supplier" required></th>
			              	</tr>
			              	<tr>
			                	<th>Nominal</th>
			                	<th><input type="number" name="nominal" required></th>
			              	</tr>
			              	<tr>
			                	<th>Jumlah</th>
			                	<th><input type="number" name="stok" required></th>
			              	</tr>
			              	<tr>
			                	<th>Satuan</th>
						...
						<table>
				            <tr>
				            	<th>
				            		<input type="submit" name="tambah" value="Simpan Barang" class="right waves-effect waves-light btn blue darken-2" style="float: left;">
				            	</th>
				            	<th style="width: 1%;">
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO barang_masuk(kode_barang,nama_barang,kapal,tanggal,supplier,nominal,stok,satuan) VALUES('$kode_barang','$nama_barang','$kapal','$tanggal','$supplier','$nominal','$stok','$satuan')"); 
            $result2 = mysqli_query($koneksi, "INSERT INTO gudang(kode_barang,nama_barang,kapal,tanggal,supplier,nominal,stok,satuan) VALUES('$kode_barang','$nama_barang','$kapal','$tanggal','$supplier','$nominal','$stok','$satuan')"); 
