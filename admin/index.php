...
session_start();
  ...
  $con = mysqli_connect($user,$nama_barang,$pass,$dbname);
	        ...
	        <nav class="row top-nav grey darken-2">
	    		<div class="container">
	    			<div class="col offset-l2 nav-wrapper">
	    				...
	    				<a class="page-title">Register Barang Masuk Keluar</a>
	    			</div>
	    		</div>
			</nav>
			    ...
			    <ul class="collapsible collapsible-accordion">
			      <li>
			        <div class="user-view">
			          ...
			          <span class="white-text name"><?php echo $nama; ?></span>
			        </div>
			      </li>
			      ...
			      <li>
			        ...
			        <div class="collapsible-body">
			          <ul>
						...
						<li><a href="laporan-barang-masuk.php" target="_blank">Barang masuk</a></li>
						<li><a href="laporan-barang-keluar.php" target="_blank">Barang keluar</a></li>
