...
{ 
  ...
  // update user data
  $result = mysqli_query($koneksi, "UPDATE users SET nik='$nik',nama='$nama_barang',alamat='$alamat',telepon='$mobile',divisi='$divisi',loker='$loker',level='$level' WHERE id=$id");
					...
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
							...
							<tr>
					      	...
					      	<tr> 
					        	<td>Nomor Telepon</td>
					        	<td><input type="number" name="telepon" value=<?php echo $mobile;?>></td>
					      	</tr>
					      	<tr> 
					        	<td>Divisi</td>
