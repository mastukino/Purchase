	...
	<div class="row">
				...
				<form action="" method="post" name="form1">
					<div class="col s12 m12 l12 card-panel z-depth"> <br>
						<table class="highlight">
				            ...
				            <tr>
				              <th>Alamat</th>
				              <th><textarea type="text" name="alamat" rows="3" required maxlength="50"></textarea></th>
				            </tr>
				            <tr>
				              <th>Telepon</th>
        ...
        <?php
          ...
          if(isset($_POST['tambah'])) {
            ...
            $result = mysqli_query($koneksi, "INSERT INTO users(nik,nama,alamat,telepon,divisi,loker,username,password,level) VALUES('$nik','$nama_barang','$alamat','$telepon','$divisi','$loker','$username','$password','$level')");
